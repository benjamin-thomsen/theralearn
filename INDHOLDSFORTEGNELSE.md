...
## Projektstyring og autoritet

- [`INDHOLDSFORTEGNELSE.md`](./INDHOLDSFORTEGNELSE.md)
...
- [`docs/company/BUSINESS_MODEL.md`](./docs/company/BUSINESS_MODEL.md)
- [`docs/company/COMPANY_ROADMAP.md`](./docs/company/COMPANY_ROADMAP.md)
- [`docs/company/COMPETITIVE_ADVANTAGE.md`](./docs/company/COMPETITIVE_ADVANTAGE.md)
- [`docs/company/MARKET_POSITION.md`](./docs/company/MARKET_POSITION.md)
- [`docs/company/MISSION.md`](./docs/company/MISSION.md)
...
- [`docs/design/icons.md`](./docs/design/icons.md)
- [`docs/design/README.md`](./docs/design/README.md)
- [`docs/design/typography.md`](./docs/design/typography.md)
- [`docs/design/ui-principles.md`](./docs/design/ui-principles.md)
- [`docs/design/ux-principles.md`](./docs/design/ux-principles.md)
...
- [`docs/development/deployment-workflow.md`](./docs/development/deployment-workflow.md)
- [`docs/development/DEVELOPER_TOOLKIT_ARCHITECTURE.md`](./docs/development/DEVELOPER_TOOLKIT_ARCHITECTURE.md)
- [`docs/development/DEVELOPER_TOOLKIT_LAYERS.md`](./docs/development/DEVELOPER_TOOLKIT_LAYERS.md)
- [`docs/development/DEVELOPER_TOOLKIT_MODULES.md`](./docs/development/DEVELOPER_TOOLKIT_MODULES.md)
...
- [`docs/foundation/FOUNDATION_MODEL.md`](./docs/foundation/FOUNDATION_MODEL.md)
- [`docs/foundation/README.md`](./docs/foundation/README.md)
- [`docs/foundation/RESPONSIBILITY_MODEL.md`](./docs/foundation/RESPONSIBILITY_MODEL.md)
...
- [`docs/guides/supabase.md`](./docs/guides/supabase.md)
- [`docs/guides/troubleshooting.md`](./docs/guides/troubleshooting.md)
- [`docs/meetings/decisions-log.md`](./docs/meetings/decisions-log.md)
...
- [`docs/references/terminology.md`](./docs/references/terminology.md)
- [`docs/templates/adr-template.md`](./docs/templates/adr-template.md)
- [`docs/templates/bug-template.md`](./docs/templates/bug-template.md)
...
- [`docs/templates/meeting-template.md`](./docs/templates/meeting-template.md)
- [`docs/templates/README.md`](./docs/templates/README.md)
- [`docs/templates/release-template.md`](./docs/templates/release-template.md)
...
- [`app/creator-objective/learningDesignReview.ts`](./app/creator-objective/learningDesignReview.ts)
...
- [`app/om/page.module.css`](./app/om/page.module.css)
- [`app/om/page.tsx`](./app/om/page.tsx)
...
- [`app/pensum/page.tsx`](./app/pensum/page.tsx)
- [`app/quiz/[slug]/page.module.css`](./app/quiz/[slug]/page.module.css)
- [`app/quiz/[slug]/page.tsx`](./app/quiz/[slug]/page.tsx)
- [`app/quiz/page.module.css`](./app/quiz/page.module.css)
- [`app/quiz/page.tsx`](./app/quiz/page.tsx)
- [`app/resultater/[slug]/page.module.css`](./app/resultater/[slug]/page.module.css)
- [`app/resultater/[slug]/page.tsx`](./app/resultater/[slug]/page.tsx)
- [`app/resultater/page.module.css`](./app/resultater/page.module.css)
- [`app/resultater/page.tsx`](./app/resultater/page.tsx)
- [`app/robots.ts`](./app/robots.ts)
- [`app/signup/page.module.css`](./app/signup/page.module.css)
...
- [`components/BoundedLearningDesignSlice.test.ts`](./components/BoundedLearningDesignSlice.test.ts)
...
- [`components/ProgressBar.tsx`](./components/ProgressBar.tsx)
- [`components/QuizCard.module.css`](./components/QuizCard.module.css)
- [`components/QuizCard.tsx`](./components/QuizCard.tsx)
- [`components/ResultatCard.module.css`](./components/ResultatCard.module.css)
- [`components/ResultatCard.tsx`](./components/ResultatCard.tsx)
- [`components/ValueCard.module.css`](./components/ValueCard.module.css)
- [`components/ValueCard.tsx`](./components/ValueCard.tsx)

---

## Data

- [`data/om.ts`](./data/om.ts)
- [`data/pensum.ts`](./data/pensum.ts)
- [`data/quiz.ts`](./data/quiz.ts)
- [`data/resultater.ts`](./data/resultater.ts)
...
- [`lib/repositories/flashcards.ts`](./lib/repositories/flashcards.ts)
- [`lib/repositories/helpers/throwRepositoryError.ts`](./lib/repositories/helpers/throwRepositoryError.ts)
- [`lib/repositories/lessons.ts`](./lib/repositories/lessons.ts)
...
- [`lib/subject-matter-intake/openAiSourceGroundingReassessmentProvider.test.ts`](./lib/subject-matter-intake/openAiSourceGroundingReassessmentProvider.test.ts)
- [`lib/subject-matter-intake/openAiSourceGroundingReassessmentProvider.ts`](./lib/subject-matter-intake/openAiSourceGroundingReassessmentProvider.ts)
- [`lib/subject-matter-intake/relevantContext.ts`](./lib/subject-matter-intake/relevantContext.ts)
- [`lib/subject-matter-intake/sourceGroundingReassessment.ts`](./lib/subject-matter-intake/sourceGroundingReassessment.ts)
...
- [`tools/docs/commands/check.ts`](./tools/docs/commands/check.ts)
- [`tools/docs/commands/checkpoint.ts`](./tools/docs/commands/checkpoint.ts)
- [`tools/docs/commands/copy.ts`](./tools/docs/commands/copy.ts)
- [`tools/docs/commands/edit.ts`](./tools/docs/commands/edit.ts)
- [`tools/docs/commands/file.ts`](./tools/docs/commands/file.ts)
- [`tools/docs/commands/help.ts`](./tools/docs/commands/help.ts)
- [`tools/docs/commands/index.ts`](./tools/docs/commands/index.ts)
- [`tools/docs/commands/patch.ts`](./tools/docs/commands/patch.ts)
- [`tools/docs/commands/replace.ts`](./tools/docs/commands/replace.ts)
- [`tools/docs/commands/search.ts`](./tools/docs/commands/search.ts)
- [`tools/docs/commands/status.ts`](./tools/docs/commands/status.ts)
- [`tools/docs/commands/verify.ts`](./tools/docs/commands/verify.ts)
- [`tools/docs/config/documentation-config.ts`](./tools/docs/config/documentation-config.ts)
- [`tools/docs/config/required-directories.ts`](./tools/docs/config/required-directories.ts)
- [`tools/docs/core/checkDocumentationStructure.ts`](./tools/docs/core/checkDocumentationStructure.ts)
- [`tools/docs/core/runBuild.ts`](./tools/docs/core/runBuild.ts)
- [`tools/docs/core/runCheck.ts`](./tools/docs/core/runCheck.ts)
- [`tools/docs/core/runCheckpoint.ts`](./tools/docs/core/runCheckpoint.ts)
- [`tools/docs/core/runCommand.ts`](./tools/docs/core/runCommand.ts)
- [`tools/docs/core/runCopy.ts`](./tools/docs/core/runCopy.ts)
- [`tools/docs/core/runEdit.ts`](./tools/docs/core/runEdit.ts)
- [`tools/docs/core/runFile.ts`](./tools/docs/core/runFile.ts)
- [`tools/docs/core/runIndex.ts`](./tools/docs/core/runIndex.ts)
- [`tools/docs/core/runPatch.test.ts`](./tools/docs/core/runPatch.test.ts)
- [`tools/docs/core/runPatch.ts`](./tools/docs/core/runPatch.ts)
- [`tools/docs/core/runReplace.ts`](./tools/docs/core/runReplace.ts)
- [`tools/docs/core/runSearch.ts`](./tools/docs/core/runSearch.ts)
- [`tools/docs/core/runStatus.ts`](./tools/docs/core/runStatus.ts)
- [`tools/docs/core/runVerification.ts`](./tools/docs/core/runVerification.ts)
- [`tools/docs/editor/openFileInEditor.ts`](./tools/docs/editor/openFileInEditor.ts)
- [`tools/docs/filesystem/exists.ts`](./tools/docs/filesystem/exists.ts)
- [`tools/docs/filesystem/readFile.ts`](./tools/docs/filesystem/readFile.ts)
- [`tools/docs/filesystem/truncateFile.ts`](./tools/docs/filesystem/truncateFile.ts)
- [`tools/docs/filesystem/writeFile.ts`](./tools/docs/filesystem/writeFile.ts)
- [`tools/docs/git/getGitStatus.ts`](./tools/docs/git/getGitStatus.ts)
- [`tools/docs/output/outputHeader.ts`](./tools/docs/output/outputHeader.ts)
- [`tools/docs/output/printDocumentationStructureResult.ts`](./tools/docs/output/printDocumentationStructureResult.ts)
- [`tools/docs/output/printEditError.ts`](./tools/docs/output/printEditError.ts)
- [`tools/docs/output/printEditSuccess.ts`](./tools/docs/output/printEditSuccess.ts)
...
- [`public/browserconfig.xml`](./public/browserconfig.xml)
